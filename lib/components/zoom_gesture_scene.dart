...
import 'package:flutter_application_1/components/profile_card_sprite.dart';
...
class ZoomGestureScene extends GSprite {
  ...
  Future<void> addedToStage() async {
    ...
    final card = ProfileCardSprite(
      events: events,
      avatarUrl:
          'https://c-ssl.dtstatic.com/uploads/blog/202410/20/XxSOq479iQWalM9.thumb.300_0.jpeg_webp',
      avatarBorderUrl:
          "https://fastly.jsdelivr.net/gh/rquanx/my-statics@master/images/123.png",
      tags: ['标签1', '标签22', '标签333'],
      nameText: '角色名',
    );
  ...
  void setZoom(double zoom) {
    ...
    content.scale = finalZoom;
    events.emit("zoom", finalZoom);
  }
